...
export function KeyMetrics() {
  return (
    <section className="max-w-7xl mx-auto px-4 mb-32 reveal">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 border-y bg-slate-900/20 border-white/5 pt-12 pb-12">
...
={{ transitionDelay: '200ms' }}>
          ...
          <p className="uppercase text-sm font-light text-slate-500">Uptime</p>
        </div>
